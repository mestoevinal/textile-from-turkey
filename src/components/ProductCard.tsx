  ...
  return (
    <>
      <div className="bg-white rounded-2xl shadow-[0_0_10px_rgba(0,0,0,0.08)] hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100">
        {/* Image slider */}
        <div 
          className="aspect-[3/2] sm:aspect-[4/3] bg-gradient-to-br from-gray-50 to-gray-100 relative group cursor-pointer"
            ...
            <>
              ...
              {hasMultipleImages && (
                <>
                  <button
                    onClick={prevImage}
                    className="absolute left-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-white/50 hover:bg-white/80 active:bg-white rounded-full flex items-center justify-center transition-all shadow-sm text-gray-700 cursor-pointer"
                  >
                    ‹
                  </button>
                  <button
                    onClick={nextImage}
                    className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-white/50 hover:bg-white/80 active:bg-white rounded-full flex items-center justify-center transition-all shadow-sm text-gray-700 cursor-pointer"
                  >
                    ›
                  </button>
                </>
        ...
        <div className="p-3 sm:p-4">
          ...
          <a 
            ...
            className="w-full mt-3 py-2.5 px-4 bg-gray-50 hover:bg-gray-100 active:bg-gray-200 text-gray-700 font-medium rounded-xl transition-colors text-sm flex items-center justify-center gap-2 border border-gray-200 cursor-pointer"
          >
      ...
      {isModalOpen && (
        ...
        >
          <button
            onClick={() => setIsModalOpen(false)}
            className="absolute top-4 right-4 w-10 h-10 bg-white/90 hover:bg-white rounded-full flex items-center justify-center text-gray-800 text-xl shadow-lg z-10 cursor-pointer"
          >
            ×
          </button>
          ...
          {hasMultipleImages && (
            <>
              ...
              <button
                ...
                className="hidden md:flex absolute left-4 top-1/2 -translate-y-1/2 w-11 h-11 bg-white/90 hover:bg-white active:bg-gray-100 rounded-full items-center justify-center text-gray-800 text-2xl font-bold shadow-lg cursor-pointer"
              >
                ‹
              </button>
              <button
                ...
                className="hidden md:flex absolute right-4 top-1/2 -translate-y-1/2 w-11 h-11 bg-white/90 hover:bg-white active:bg-gray-100 rounded-full items-center justify-center text-gray-800 text-2xl font-bold shadow-lg cursor-pointer"
              >
                ›
              </button>
            </>
